...
export default class AuthorisedSignatures {
    ...
    SelectAuthorisedSignaturesById(data) {
        return new Promise((resolve, reject) =>{
            this.pool.query(
                `SELECT * FROM registerbranch_authorised_signatures WHERE id = ?`,
                [
                    data.id
                ],
    ...
    SelectAuthorisedSignaturesByApplicationId(data) {
        return new Promise((resolve, reject) =>{
            this.pool.query(
                ...
                mobile,
                email
                FROM registerbranch_authorised_signatures WHERE application_id = ?`,
                [
                    data.application_id
                ],
                (error, results, fields) => {
    ...
    InsertAuthorisedSignatures(data) {
        return new Promise((resolve, reject) =>{
            this.pool.query(
                `INSERT INTO registerbranch_authorised_signatures
                (
                    application_id,
                    title,
                    name,
    ...
    UpdateAuthorisedSignatures(data) {
        return new Promise((resolve, reject) =>{
            this.pool.query(
                `UPDATE registerbranch_authorised_signatures SET
                title = ?,
                name = ?,
                phone = ?,
                mobile = ?,
    ...
    DeleteSignaturesByApplicationId(data) {
        return new Promise((resolve, reject) =>{
            this.pool.query(
                `DELETE FROM registerbranch_authorised_signatures WHERE application_id = ?`,
                [
                    data.application_id
                ],
                (error, results, fields) => {
