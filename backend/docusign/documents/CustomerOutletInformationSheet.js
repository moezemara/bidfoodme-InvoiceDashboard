		...
		<body>
			<section style="width:120%;max-width:900px;margin: 0 auto;padding:0 30px;">
				<table class="main_tbl" width="100%" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td align="center" bgcolor="#171147" style="font-size: 20px;text-transform:uppercase;color: #fff;font-weight: 600;">customer informationsheet</td>
					</tr>
					<tr>
						<td align="center" style="font-size: 16px;color: #171147;text-transform:capitalize;font-weight: bold;padding:10px 0;">Outlet Opening Form</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
						<td class="p0">
							<table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #0f1c4e;padding:10px 8px;margin-top: 20px;">
								<tr>
									<td>
										<div class="flex">
											<label for="">Legal Name of Outlet:</label>
								...
								<tr>
									<td class="pt">
										<div class="flex">
											<label for="">Trade Name of Outlet:</label>
								...
								<td class="pt">
									<div class="flex">
										<label for="">Group Name of Outlet:</label>
										<value>${data.outlet_group_name || ""}</value>
									</div>
								</td>
							</tr>
							</table>
					...
					<tr>
						<td class="p0">
							<table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #0f1c4e;padding:10px 8px;margin-top: 15px;">
								<tr>
									<td colspan="3">
										<div class="flex">
